  ...
  <section className="text-gray-600 body-font relative">
    <div className="container px-5 py-24 mx-auto">
      <div className="flex flex-col text-center w-full mb-12">
        <h1 className="sm:text-3xl text-3xl font-bold title-font mb-4 text-gray-200">Contact Us</h1>
        <p className="lg:w-2/3 mx-auto leading-relaxed text-base text-gray-500">
          Have a question or need support? We're here to help. Send us a message and our team will get back to you shortly.
        </p>
      </div>
      <div className="lg:w-1/2 md:w-2/3 mx-auto">
        <div className="flex flex-wrap -m-2">
          ...
          <div className="p-2 w-full">
            <button
              className="flex mx-auto text-white bg-indigo-500 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded-lg text-lg transition duration-200">
              Send Message
            </button>
          </div>
          <div className="p-2 w-full pt-8 mt-8 border-t border-gray-200 text-center">
            <a href="mailto:support@golink.com" className="text-indigo-500">support@golink.com</a>
            ...
            <span className="inline-flex">
              ...
              <a className="ml-4 text-gray-500 hover:text-indigo-500">
                <svg fill="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" className="w-5 h-5"
                  viewBox="0 0 24 24">
                  <path
